...
namespace gbbs
{
    namespace LowAvgStretch
    {
        ...
        double BallGrowing_radius_runner(Graph &G, commandLine P)
        {
            ...
            timer t;
            t.start();
            LowAvgStretch::BFS_radius(G, srcs, radius, parents, clusters, dists, edges);
            double tt = t.stop();
        ...
        double BallGrowing_runner(Graph &G, commandLine P)
        {
            ...
            sequence<size_t> r0s;
            t.start();
            LowAvgStretch::BallGrowing(G, srcs, ball, ballShell, parents, clusters, cluster_index, edges, radii, gen, dists, r0s);
            double tt = t.stop();
