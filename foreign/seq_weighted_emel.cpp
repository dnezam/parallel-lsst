#include "basics.h"
#include "foreign/EmelElkin.h"
#include "foreign/benchmark.h"
#include "lemon/include/lemon/list_graph.h"
#include <lemon/connectivity.h>
using namespace lemon;
std::tuple<bool, double, double> seq_weighted_emel(lemon::ListGraph &input) {
  ...
  double AvgEStretch, MaxEStretch, AvgEStretchB, MaxEStretchB, AvgPStretch,
      MaxPStretch;
  EmelElkin ee(input, length);
  auto start_t = std::chrono::high_resolution_clock::now();
  ee.run(x0, output, lengthNew, TNewId, TOldId);
