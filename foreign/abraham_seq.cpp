...
void AbrahamBartal_seq::HierarStarPart(
  ...
  while (j < sd.k + 1) {
    ...
    HierarStarPart(Gnew[j], newId[OldCorr[sd.x[j]]], lGnewj, Qj, GjTree,
                   lengthNew, treeId, origId);
...
QDecomp AbrahamBartal_seq::StarPart(const ListGraph &G, ListGraph::Node x0,
